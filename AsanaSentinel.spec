...
a = Analysis(
    ['C:\\Users\\Kapil Tulsan\\OneDrive - Kapil R Tulsan\\PyCharms\\AsanaTaskDashboard\\AsanaTaskDashboard\\backend\\main.py'],
    pathex=[],
    binaries=[],
    datas=[('C:\\Users\\Kapil Tulsan\\OneDrive - Kapil R Tulsan\\PyCharms\\AsanaTaskDashboard\\AsanaTaskDashboard\\backend\\static', 'static')],
